...
|-------------------------------|--------------------------|
| getCentralValue() : double    | Returns a central value  | (Nicole)
| getLength() : double          | Returns a length         | (Nelson)
| getLowerBound() : double      | Returns the lower bound  | (Nelson)
| getUpperBound() : double      | Returns the upper bound  | (Nelson)
| toString() : java.lang.String | Returns a string         | (Nicole)
...
Statement:
![alt text](Test_Screenshots/Statement_Range.png)

Branch:
![alt text](Test_Screenshots/Branch_Range.png)

Method:
![alt text](Test_Screenshots/Method_Range.png)
